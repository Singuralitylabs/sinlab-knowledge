...
export default function GoogleLoginButton({ returnTo }: Props) {
  ...
  return (
    <button
      type="button"
      className="flex items-center gap-3 px-8 py-4 bg-white border-2 border-gray-200 rounded-lg hover:bg-gray-50 transition-colors shadow-sm hover:shadow-md text-lg font-medium disabled:opacity-60"
